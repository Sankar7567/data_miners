...
def generate_pdf_from_markdown(md_text: str, output_path: Path, subsidiary: str, timeframe: str):
    ...
    body = ParagraphStyle('DocBody', parent=styles['Normal'], fontName='Helvetica', fontSize=8, leading=11.5, textColor=colors.HexColor('#1E293B'), spaceAfter=3)
    bullet_style = ParagraphStyle('DocBullet', parent=styles['Normal'], fontName='Helvetica', fontSize=8, leading=11, leftIndent=12, textColor=colors.HexColor('#1E293B'), spaceAfter=2.5)
